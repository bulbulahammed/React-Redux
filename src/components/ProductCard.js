...
const ProductCard = ({ product }) => {
  ...
  return (
    <div
      ...
      key={product._id}
    >
{pathname.includes('cart') &&(<div className="bg-indigo-500 text-white p-1 rounded-full absolute w-8 h-8 top-5 right-5 grid place-items-center"><p>{product.quantity}</p></div>)}
